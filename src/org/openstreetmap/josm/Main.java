 ...
 *
 * notes
 *  new static field platformFactory
 *  constructor Main():
 *      all commented out
 *  removeLayer:
 *      don't allow destruction of mapframe
 *  addLayer:
 *      assume, that map is not null (has to be created on application start)
 */

public class Main {

    public static PlatformFactory platformFactory;
