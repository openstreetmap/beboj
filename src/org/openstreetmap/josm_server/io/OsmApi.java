...
//            }
     ...
     */
    public void createPrimitive(IPrimitive osm, CredentialsManagerResponse credentials, ProgressMonitor monitor) throws OsmTransferException {
        String ret = "";
        try {
     ...
     * @throws OsmTransferException if something goes wrong
     */
    public void modifyPrimitive(IPrimitive osm, CredentialsManagerResponse credentials, ProgressMonitor monitor) throws OsmTransferException {
        String ret = null;
        try {
            ensureValidChangeset();
            initialize(monitor);
     ...
     * @throws OsmTransferException if something goes wrong
     */
    public void deletePrimitive(IPrimitive osm, CredentialsManagerResponse credentials, ProgressMonitor monitor) throws OsmTransferException {
        ensureValidChangeset();
        initialize(monitor);
     ...
     */
    public Map<PrimitiveId, DiffResultEntry> uploadDiff(Collection<? extends IPrimitive> list, CredentialsManagerResponse credentials, ProgressMonitor monitor) throws OsmTransferException {
        try {
